...
This toolkit ships two templates in `docs/adr/toolkit/assets/templates/`.

## Simple

File: `docs/adr/toolkit/assets/templates/adr-simple.md`
...
File: `docs/adr/toolkit/assets/templates/adr-madr.md`
