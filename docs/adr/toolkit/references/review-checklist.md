...
- [ ] Constraints are explicit and measurable where possible (e.g., "under 200ms p95" not "fast enough")
...
- [ ] No criterion is vague ("it performs well" → "p95 latency under 200ms with 100 concurrent requests")
