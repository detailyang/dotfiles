---
name: herdr
description: Control Herdr workspaces, tabs, panes, terminals, or recognized coding agents. Trigger only when the user explicitly mentions Herdr or asks to inspect/control work through Herdr; do not use merely for delegation, parallelism, or a background terminal. Requires HERDR_ENV=1.
---
