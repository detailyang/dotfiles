...
import {
	MAX_HL_CHARS,
	ShikiHighlightCache,
} from "../extensions/diff-view/renderer/tool/diff/shiki-highlight.ts";
import { shouldHighlightCodeBlock } from "../extensions/diff-view/renderer/tool/diff/diff-renderer.ts";
import { sanitizeToolResultText } from "../extensions/diff-view/utils/tool-result-sanitize.ts";
