<!-- Managed by the Pi adr extension. Source: https://github.com/vercel/ai/tree/main/skills/adr-skill (9d9a73f1551f2243035491e9de5a2e00ebf9eb17). -->
## Purpose
...
- Code adds one lightweight `ADR: <path>` comment at a relevant entry point when the reason would otherwise be hard to discover.
