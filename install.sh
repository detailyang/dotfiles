...
function install_mac_app() {
    ...
    readonly apps=(Proxifier shottr Hovrly NetNewsWire amphetamine bartender enpass snippetslab eudic reeder dash karabiner itsycal paper hammersppon lulu SwitchHosts kap PicGo)
